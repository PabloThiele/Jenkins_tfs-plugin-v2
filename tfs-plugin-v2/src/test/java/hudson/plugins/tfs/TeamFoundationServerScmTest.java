...
public class TeamFoundationServerScmTest {
        ...
        try {
            ...
            final String xmlString =
                    "<scm class='hudson.plugins.tfs.TeamFoundationServerScm' plugin='tfs@3.1.1'>\n" +
                            ...
                            "    <showWorkspaces>true</showWorkspaces>\n" +
                            "</scm>";
            ...
            final String expectedUpgradedXml =
                    "<hudson.plugins.tfs.TeamFoundationServerScm>\n" +
                            ...
                            "  <useUpdate>false</useUpdate>\n" +
                            "  <showWorkspaces>true</showWorkspaces>\n" +
                            "  <useTFSUserNameOnSearch>false</useTFSUserNameOnSearch>\n" +
                            "</hudson.plugins.tfs.TeamFoundationServerScm>";
    ...
    public void assertWorkspaceNameReplacesJobName() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "erik_${JOB_NAME}", true, true);
    ...
    public void assertDefaultValueIsUsedForEmptyLocalPath() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "", false, "workspace", true, true);
    ...
    public void assertDefaultValueIsUsedForEmptyWorkspaceName() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", ".", false, "", true, true);
    ...
    public void assertGetModuleRootReturnsWorkFolder() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "workfolder", false, "", true, true);
    ...
    public void assertWorkspaceNameIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", ".", false, "WORKSPACE_SAMPLE", true, true);
        AbstractBuild build = mock(AbstractBuild.class);
        AbstractProject project = mock(AbstractProject.class);
        when(build.getProject()).thenReturn(project);
    ...
    public void assertWorksfolderPathIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "PATH", false, "WORKSPACE_SAMPLE", true, true);
    ...
    public void assertTfsUserNameIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "projectpath", "PATH", false, "WORKSPACE_SAMPLE", "user", (Secret) null, true, true);
        Map<String, String> env = new HashMap<String, String>();
        scm.buildEnvVars(mock(AbstractBuild.class), env );        
    ...
    @Test public void recordWorkspaceChangesetVersion() throws Exception {
        final TeamFoundationServerScm scm = new TeamFoundationServerScm("serverUrl", "projectPath", "localPath", false, "workspace", true, true);
    ...
    public void assertWorkspaceNameReplacesInvalidChars() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "A\"B/C:D<E>F|G*H?I", true, true);
    ...
    public void assertWorkspaceNameReplacesEndingPeriod() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "Workspace.Name.", true, true);
    ...
    @Test public void assertServerUrlResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("https://${PARAM}.com", null, ".", false, "", true, true);
    ...
    @Test public void assertProjectPathResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, "$/$PARAM/path", ".", false, "", true, true);
    ...
    @Test public void assertWorkspaceNameResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, ".", false, "WS-${PARAM}", true, true);
    ...
    @Test public void assertTfsWorkspaceIsntRemovedIfThereIsNoBuildWhenProcessWorkspaceBeforeDeletion() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("server", "projectpath", ".", false, "workspace", true, true);
