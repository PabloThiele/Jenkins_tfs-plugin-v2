...
public class CheckoutAction {
    ...
    public CheckoutAction(String workspaceName, String projectPath, String localFolder, boolean useUpdate, boolean showWorkspaces, boolean useTFSUserNameOnSearch) {
    ...
    private Project getProject(Server server, FilePath workspacePath)
        ...
        if (workspaces.exists(workspaceName, showWorkspaces, useTFSUserNameOnSearch) && !useUpdate) {
            Workspace workspace = workspaces.getWorkspace(workspaceName, showWorkspaces, useTFSUserNameOnSearch);
            workspaces.deleteWorkspace(workspace);
        }
        
        Workspace workspace;
        if (! workspaces.exists(workspaceName, showWorkspaces, useTFSUserNameOnSearch)) {
            ...
            workspace = workspaces.getWorkspace(workspaceName, showWorkspaces, useTFSUserNameOnSearch);
        }
		return project;
	}
