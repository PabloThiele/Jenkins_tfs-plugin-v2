...
public class TeamFoundationServerScm extends SCM {
    ...
    private final boolean useTFSUserNameOnSearch;
    ...
    @Deprecated
    public TeamFoundationServerScm(String serverUrl, String projectPath, String localPath, boolean useUpdate, String workspaceName, String userName, String password, boolean showWorkspaces, boolean useTFSUserNameOnSearch) {
        this(serverUrl, projectPath, localPath, useUpdate, workspaceName, userName, Secret.fromString(password), showWorkspaces, useTFSUserNameOnSearch);
    }

    TeamFoundationServerScm(String serverUrl, String projectPath, String localPath, boolean useUpdate, String workspaceName, boolean showWorkspaces, boolean useTFSUserNameOnSearch) {
        this(serverUrl, projectPath, localPath, useUpdate, workspaceName, null, (Secret)null, showWorkspaces, useTFSUserNameOnSearch);
    }

    @DataBoundConstructor
    public TeamFoundationServerScm(String serverUrl, String projectPath, String localPath, boolean useUpdate, String workspaceName, String userName, Secret password, boolean showWorkspaces, boolean useTFSUserNameOnSearch) {
        ...
        this.useTFSUserNameOnSearch = useTFSUserNameOnSearch;
    }
    ...
    public boolean isUseTFSUserNameOnSearch() {
        return useTFSUserNameOnSearch;
    }
        ...
        try {
            ...
            if (previousBuild != null) {
                ...
                if ((nodeConfiguration != null) &&
                    ...
                    new RemoveWorkspaceAction(workspaceConfiguration.getWorkspaceName()).remove(server, showWorkspaces, useTFSUserNameOnSearch);
            ...
            CheckoutAction action = new CheckoutAction(workspaceConfiguration.getWorkspaceName(), workspaceConfiguration.getProjectPath(), workspaceConfiguration.getWorkfolder(), isUseUpdate(), isShowWorkspaces(), isUseTFSUserNameOnSearch());
            List<ChangeSet> list;
    ...
    public boolean processWorkspaceBeforeDeletion(AbstractProject<?, ?> project, FilePath workspace, Node node) throws IOException, InterruptedException {
        ...
        if ((configuration != null) && configuration.workspaceExists()) {
            ...
            Server server = createServer(launcher, listener, lastRun);
            try {
                if (new RemoveWorkspaceAction(configuration.getWorkspaceName()).remove(server, showWorkspaces, useTFSUserNameOnSearch)) {
